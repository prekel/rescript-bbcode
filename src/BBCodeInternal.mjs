...
function fix_ast$1(ast) {
  return $$Array.of_list(List.rev(List.fold_left((function (state, el) {
                        if (!state) {
                          return {
                                  hd: el,
                                  tl: state
...
function ast_to_public(txt) {
  switch (txt.TAG | 0) {
    ...
    case /* Bold */1 :
        return {
                TAG: /* Bold */1,
                children: $$Array.map(ast_to_public, fix_ast$1(txt.children))
              };
    case /* Italic */2 :
        return {
                TAG: /* Italic */2,
    ...
    case /* List */18 :
        return {
                ...
                items: $$Array.map((function (param) {
                        return /* ListItem */{
                                children: $$Array.map(ast_to_public, fix_ast$1(param.children))
                              };
                      }), txt.items),
                variant: txt.variant
              };
...
function parse(x) {
  return Belt_Option.map(run1(x, ast_parer(false)), (function (a) {
                return $$Array.of_list(List.map(ast_to_public, a));
              }));
}
