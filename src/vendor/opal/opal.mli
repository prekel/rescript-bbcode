...
val ( >>= ) : ('token, 'a) parser -> ('a -> ('token, 'b) parser) -> ('token, 'b) parser
...
val ( <~> ) : ('token, 'a) parser -> ('token, 'a list) parser -> ('token, 'a list) parser
...
val sep_by1 : ('token, 'a) parser -> ('token, 'b) parser -> ('token, 'a list) parser
val sep_by : ('token, 'a) parser -> ('token, 'b) parser -> ('token, 'a list) parser
val end_by1 : ('token, 'a) parser -> ('token, 'b) parser -> ('token, 'a list) parser
val end_by : ('token, 'a) parser -> ('token, 'b) parser -> ('token, 'a list) parser
